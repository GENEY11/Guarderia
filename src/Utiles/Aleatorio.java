...
public class Aleatorio {
    ...
    public static String stringTelAleatorio(int tam){
        String res = "299";
        for(int i = 0; i < tam; i++){
            res = res + intAleatorio(0,9);
        }
        return res;
    }
    ...
    public static String nombreRazaAleatorio(){
        // ejemplo para definir un valor aleatorio entre varias posibilidades
        // en este caso nombres
        String arr[] = {"Labrador", "Golden", "Pitbul", "Ovejero", "Caniche"};
        return arr[intAleatorio(0, arr.length - 1)];
    }
    public static String nombrePerroAleatorio(){
        // ejemplo para definir un valor aleatorio entre varias posibilidades
        // en este caso nombres
        String arr[] = {"Mila", "Nina", "Roco", "Toby", "Ringo"};
        return arr[intAleatorio(0, arr.length - 1)];
    }
}
